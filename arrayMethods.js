...
const bornIn16thCentury = inventors.filter(inventor => /^15/.test(inventor.year));
console.log("Opdracht 1: ", bornIn16thCentury);
...
const allBirthYears = inventors.map(inventor => inventor.year)
console.log("Opdracht 2: ", allBirthYears);
...
console.log("Opdracht 3: ", allNames);
...
console.log("Opdracht 4: ", inventorsSorted);
...
const livedLongest = inventors.sort((a, b) => (b.passed - b.year) - (a.passed - a.year));
console.log("Opdracht 5: ", livedLongest);
...
const edison = inventors.find(inventor => inventor.last === "Edison");
console.log(edison);